      ...
      <div className="relative z-10">
        ...
        <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            a custom tool you register via <code className="rounded bg-muted px-1.5 py-0.5 text-sm">useTool</code> — is
            validated and executed by a runtime that respects the permissions you define. Your app stays in control.
          </p>
