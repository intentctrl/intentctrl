...
export const alt = "ui.intentctrl.com";
    ...
    <div tw="relative flex h-full w-full bg-black/95 text-white">
      ...
      <div tw="flex flex-col items-center p-20 justify-center text-center w-full">
        <div tw="flex flex-col items-center">
          ...
          <span tw="text-6xl font-medium tracking-tighter">ui.intentctrl.com</span>
        </div>

        <h1 tw="mt-8 text-4xl leading-[1.25] tracking-tighter max-w-3xl">Chat widgets for IntentCtrl</h1>
      </div>
    </div>,
    size,
  );
