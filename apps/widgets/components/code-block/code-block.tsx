  ...
  return (
    <div
      className={cn(
        ...
        "bg-neutral-200/40 dark:bg-neutral-900/70",
...
const CodeBlockHeader = ({ children, className, ...props }: CodeBlockHeaderProps) => {
  return (
    <div
      className={cn(
        "not-prose", // Disable Markdown Styles
        "flex h-9 items-center justify-between px-2 py-1.5",
        "text-sm text-neutral-600 dark:text-neutral-400 rounded-none",
        className,
      )}
      {...props}
    >
...
const CodeBlockGroup = ({ children, className, ...props }: CodeBlockGroupProps) => {
  return (
    <div
      className={cn("flex items-center space-x-2", "text-sm text-neutral-600 dark:text-neutral-400", className)}
      {...props}
    >
      {children}
    </div>
...
const CodeBlockContent = ({ className, children, ...props }: ComponentProps<"div">) => {
  return (
    <div
      className={cn(
        "max-h-96 overflow-y-auto",
        "bg-background dark:bg-background/80 rounded-none",
...
export { CodeBlock, CodeBlockHeader, CodeBlockIcon, CodeBlockGroup, CodeBlockContent };
