...
IntentCtrl organizes conversations into sessions. A session persists the chat history so users can pick up where they left off, even after closing the page.
