...
description: Set up IntentCtrl in your app in a few minutes
icon: Rocket
---
...
Wrap your application (or the part that needs AI) in `IntentCtrlProvider`. You need the URL of your AI backend and an API key.
...
export default function RootLayout({ children }) {
  return (
    <IntentCtrlProvider apiUrl="https://api.example.com/chat" apiKey={process.env.NEXT_PUBLIC_API_KEY!}>
      {children}
    </IntentCtrlProvider>
  );
}
