...
Wrap your application (or the part that needs AI) in `IntentCtrlProvider`. You need an API key and the URL of an AI backend. Use the [cloud platform](http://app.intentctrl.com) directly, or [self-host the backend](https://github.com/intentctrl) for free.
