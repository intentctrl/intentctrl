...
import { type ComponentProps, createElement, type FC, type ReactNode, useMemo, useRef, useState } from "react";
            ...
            <>
              {navMode === "auto" && (
                <div className="flex justify-between">
                  {slots.navTitle && <slots.navTitle className="inline-flex items-center gap-2.5 font-medium" />}
                  {nav?.children}
                  {collapsible && (
